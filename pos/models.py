...
class Supplier(models.Model):
    ...
    phone = models.CharField(max_length=20, unique=True)  # Added unique=True, removed blank=True
...
class Customer(models.Model):
    name = models.CharField(max_length=100)
    phone = models.CharField(max_length=20, blank=True, null=True, unique=True)  # Added unique=True
    email = models.EmailField(blank=True, null=True)
