...
path('supplier-returns/export/', views.export_supplier_returns, name='export_supplier_returns'),
    ...
    path('activity-logs/', views.activity_logs_view, name='activity_logs_view'),
    path('admin/activity-logs/', views.activity_logs_view, name='admin_activity_logs'),
    path('activity-log/<int:pk>/', views.activity_log_detail, name='activity_log_detail'),
    path('check-phone/', views.check_phone_exists, name='check_phone_exists'),
