...
import time 
from pos.decorators import permission_required, role_required, login_and_permission_required
# At the top of views.py, add these imports if they're not already there
...
# (All your view functions, imports, etc.)
...
# Permission wrapper for existing views
def apply_permissions_to_views():
    """
    Apply permission checks to existing view functions without modifying them.
    Call this function after all view definitions.
    """
    # Map view function names to required permissions
    permission_mapping = {
        # Dashboard
        ...
        # Sales
        'sales_report': 'can_view_all_sales',
        'view_sale': 'can_view_all_sales',
        'sale_detail': 'can_view_all_sales',
        'edit_sale': 'can_edit_sales',
        'delete_sale': 'can_delete_sales',
        'load_sale_to_pos': 'can_edit_sales',
        'daily_sales_report': 'can_view_all_sales',
        'daily_sales_summary': 'can_view_all_sales',
        'process_sale': 'can_process_sales',
        'save_pending_sale': 'can_process_sales',
        'complete_pending_sale': 'can_process_sales',
        
        # Products
        'product_list': 'can_view_products',
        'product_detail': 'can_view_products',
        'add_product': 'can_add_products',
        'edit_product': 'can_edit_products',
        'toggle_product_status': 'can_edit_products',
        'import_products': 'can_import_products',
        'bulk_upload': 'can_import_products',
        
        # Inventory
        'inventory_report': 'can_view_inventory',
        'stock_management': 'can_manage_stock',
        'batch_list': 'can_view_inventory',
        'batch_detail': 'can_view_inventory',
        'add_batch': 'can_manage_stock',
        'edit_batch': 'can_manage_stock',
        'delete_batch': 'can_manage_stock',
        'stock_journal_list': 'can_manage_stock',
        'add_stock_journal': 'can_manage_stock',
        'stock_journal_detail': 'can_manage_stock',
        
        # Purchases
        'purchase_list': 'can_view_purchases',
        'view_purchase': 'can_view_purchases',
        'purchase_invoice': 'can_view_purchases',
        'add_purchase': 'can_add_purchases',
        'edit_purchase': 'can_edit_purchases',
        'delete_purchase': 'can_delete_purchases',
        'pending_purchases': 'can_add_purchases',
        'pending_purchases_list': 'can_add_purchases',
        'complete_pending_purchase': 'can_add_purchases',
        'delete_pending_purchase': 'can_add_purchases',
        
        # Customers
        'customer_list': 'can_view_customers',
        'customer_detail': 'can_view_customers',
        'add_customer': 'can_add_customers',
        'edit_customer': 'can_edit_customers',
        'customer_payment': 'can_add_customers',
        
        # Suppliers
        'supplier_list': 'can_view_suppliers',
        'supplier_detail': 'can_view_suppliers',
        'add_supplier': 'can_add_suppliers',
        'edit_supplier': 'can_edit_suppliers',
        'record_payment': 'can_edit_suppliers',
        'supplier_payment_summary': 'can_view_suppliers',
        
        # Reports
        'reports_dashboard': 'can_view_reports',
        'sales_by_product_report': 'can_view_sales_reports',
        'profit_margin_report': 'can_view_profit_reports',
        'customer_sales_analysis': 'can_view_customer_reports',
        'export_report': 'can_export_reports',
        'weekly_sales_profit_report': 'can_view_sales_reports',
        'product_performance_report': 'can_view_sales_reports',
        'profit_loss_report': 'can_view_profit_reports',
        'stock_value_report': 'can_view_inventory_reports',
        'supplier_purchase_analysis': 'can_view_suppliers',
        'batch_profit_report': 'can_view_profit_reports',
        'expiry_tracking': 'can_view_inventory_reports',
        'expected_profits_report': 'can_view_profit_reports',
        
        # Financial
        'credit_payments': 'can_view_credit_sales',
        'process_credit_payment': 'can_process_credit_payments',
        'product_level_credit_payment': 'can_process_credit_payments',
        'credit_payment_history': 'can_view_credit_sales',
        'customer_payment_report': 'can_view_financials',
        'supplier_payments_report': 'can_view_financials',
        
        # Expenses
        'expense_list': 'can_view_financials',
        'add_expense': 'can_manage_settings',
        'edit_expense': 'can_manage_settings',
        'delete_expense': 'can_manage_settings',
        
        # Discounts
        'discount_list': 'can_manage_settings',
        'add_discount': 'can_manage_settings',
        'toggle_discount_status': 'can_manage_settings',
        
        # Company Settings
        'company_settings': 'can_manage_settings',
        'company_pricing': 'can_manage_settings',
        'add_company_price': 'can_manage_settings',
        'edit_company_price': 'can_manage_settings',
        
        # Receipts
        'view_receipt': 'can_view_all_sales',
        'print_receipt': 'can_view_all_sales',
        'print_receipt_direct': 'can_view_all_sales',
        'thermal_print_receipt': 'can_view_all_sales',
        'receipt_history': 'can_view_all_sales',
        
        # Admin
        'user_management_dashboard': 'can_manage_users',
        'user_list': 'can_manage_users',
        'user_detail': 'can_manage_users',
        'create_user': 'can_manage_users',
        'edit_user': 'can_manage_users',
        'toggle_user_status': 'can_manage_users',
        'reset_user_password': 'can_manage_users',
        'role_list': 'can_manage_roles',
        'role_detail': 'can_manage_roles',
        'create_role': 'can_manage_roles',
        'edit_role': 'can_manage_roles',
        'toggle_role_status': 'can_manage_roles',
        'duplicate_role': 'can_manage_roles',
        'activity_logs': 'can_manage_users',
        'bulk_import_users': 'can_manage_users',
        'user_permissions_summary': 'can_manage_users',
    }
    
    # Get the current module's globals
    import sys
    module = sys.modules[__name__]
    
    for func_name, permission in permission_mapping.items():
        if hasattr(module, func_name):
            func = getattr(module, func_name)
            # Check if the function already has the @login_required decorator
            # We'll wrap it safely
            if hasattr(func, '__wrapped__'):
                # Already has some decorator, wrap the original
                setattr(module, func_name, permission_required(permission)(func))
            else:
                setattr(module, func_name, login_required(permission_required(permission)(func)))

# Call this at the bottom of views.py
apply_permissions_to_views()


# Add this at the end of your views.py

@login_required
@user_passes_test(lambda u: u.is_superuser or (hasattr(u, 'profile') and u.profile.role and u.profile.role.name == 'admin'))
def activity_logs_view(request):
    ...
    logs = UserActivityLog.objects.select_related('user').all().order_by('-timestamp')
    ...
    model_names = UserActivityLog.objects.values_list('model_name', flat=True).distinct().order_by('model_name')
    ...
    stats = {
        ...
        'action_types': logs.values('action_type').annotate(count=Count('id')).order_by('-count'),
        'model_names': logs.values('model_name').annotate(count=Count('id')).order_by('-count')[:10],
    }
    ...
    return render(request, 'pos/admin/activity_logs_view.html', context)
...
def activity_log_detail(request, pk):
    ...
    log_entry = get_object_or_404(UserActivityLog, pk=pk)
    
    # Get related data based on the model and object_id
    related_data = None
    related_object = None
    related_model = None
    
    if log_entry.model_name and log_entry.object_id:
        try:
            ...
            model_class = model_map.get(log_entry.model_name)
            if model_class:
                try:
                    related_object = model_class.objects.get(pk=log_entry.object_id)
                    related_model = log_entry.model_name
                    
                    # Get model-specific details
                    if log_entry.model_name == 'Sale':
                        related_data = {
                            'sale_number': related_object.sale_number,
                            'customer': related_object.customer.name if related_object.customer else 'Walk-in',
                            'total': str(related_object.total),
                            'payment_method': related_object.get_payment_method_display() if hasattr(related_object, 'get_payment_method_display') else related_object.payment_method,
                            'items_count': related_object.items.count(),
                            'date': related_object.date.strftime('%Y-%m-%d %H:%M:%S') if related_object.date else None,
                            'is_completed': related_object.is_completed,
                            'is_credit': related_object.is_credit,
                            'balance': str(related_object.balance) if hasattr(related_object, 'balance') else '0',
                            'user': related_object.user.username if related_object.user else None,
                        }
                    elif log_entry.model_name == 'Purchase':
                        related_data = {
                            'invoice_number': related_object.invoice_number,
                            'supplier': related_object.supplier.name if related_object.supplier else 'Unknown',
                            'total': str(related_object.total),
                            'items_count': related_object.item_count,
                            'date': related_object.date.strftime('%Y-%m-%d %H:%M:%S') if related_object.date else None,
                            'is_paid': related_object.is_paid,
                            'payment_status': related_object.payment_status if hasattr(related_object, 'payment_status') else 'Unknown',
                            'user': related_object.user.username if related_object.user else None,
                        }
                    elif log_entry.model_name == 'Product':
                        related_data = {
                            'name': related_object.name,
                            'barcode': related_object.barcode,
                            'category': related_object.category.name if related_object.category else 'Uncategorized',
                            'purchase_price': str(related_object.purchase_price),
                            'selling_price': str(related_object.selling_price),
                            'quantity': str(related_object.quantity),
                            'reorder_level': str(related_object.reorder_level),
                            'supplier': related_object.supplier.name if related_object.supplier else 'Unknown',
                            'is_active': related_object.is_active,
                        }
                    elif log_entry.model_name == 'Customer':
                        related_data = {
                            'name': related_object.name,
                            'phone': related_object.phone,
                            'email': related_object.email,
                            'address': related_object.address,
                            'balance': str(related_object.balance),
                            'credit_limit': str(related_object.credit_limit),
                        }
                    elif log_entry.model_name == 'Supplier':
                        related_data = {
                            'name': related_object.name,
                            'contact_person': related_object.contact_person,
                            'phone': related_object.phone,
                            'email': related_object.email,
                            'address': related_object.address,
                            'balance': str(related_object.balance),
                        }
                    elif log_entry.model_name == 'User':
                        related_data = {
                            'username': related_object.username,
                            'email': related_object.email,
                            'full_name': related_object.get_full_name(),
                            'is_active': related_object.is_active,
                            'is_staff': related_object.is_staff,
                            'is_superuser': related_object.is_superuser,
                            'date_joined': related_object.date_joined.strftime('%Y-%m-%d %H:%M:%S'),
                            'last_login': related_object.last_login.strftime('%Y-%m-%d %H:%M:%S') if related_object.last_login else 'Never',
                            'role': related_object.profile.role.get_name_display() if hasattr(related_object, 'profile') and related_object.profile.role else 'No Role',
                        }
                    elif log_entry.model_name == 'Expense':
                        related_data = {
                            'description': related_object.description,
                            'category': related_object.get_category_display() if hasattr(related_object, 'get_category_display') else related_object.category,
                            'amount': str(related_object.amount),
                            'date': related_object.date.strftime('%Y-%m-%d') if related_object.date else None,
                            'user': related_object.user.username if related_object.user else None,
                        }
                    elif log_entry.model_name == 'Batch':
                        related_data = {
                            'batch_number': related_object.batch_number,
                            'product': related_object.product.name if related_object.product else 'Unknown',
                            'quantity': str(related_object.quantity),
                            'purchase_price': str(related_object.purchase_price),
                            'selling_price': str(related_object.selling_price),
                            'expiry_date': related_object.expiry_date.strftime('%Y-%m-%d') if related_object.expiry_date else 'N/A',
                            'date_received': related_object.date_received.strftime('%Y-%m-%d') if related_object.date_received else 'N/A',
                            'is_active': related_object.is_active,
                        }
                    elif log_entry.model_name == 'Discount':
                        related_data = {
                            'name': related_object.name,
                            'discount_type': related_object.get_discount_type_display() if hasattr(related_object, 'get_discount_type_display') else related_object.discount_type,
                            'amount': str(related_object.amount),
                            'start_date': related_object.start_date.strftime('%Y-%m-%d'),
                            'end_date': related_object.end_date.strftime('%Y-%m-%d'),
                            'is_active': related_object.is_active,
                            'products': [p.name for p in related_object.products.all()],
                            'categories': [c.name for c in related_object.categories.all()],
                        }
                except Exception as e:
                    related_data = {'error': f'Could not load related object: {str(e)}'}
        except Exception as e:
            related_data = {'error': f'Error loading related data: {str(e)}'}
    
    # Get related logs (same user, same model, or same object)
    related_logs = UserActivityLog.objects.filter(
        Q(user=log_entry.user) |
        Q(model_name=log_entry.model_name, object_id=log_entry.object_id)
    ).exclude(id=log_entry.id).order_by('-timestamp')[:10]
    
    # REMOVE THIS SECTION - It's causing the error
    # parsed_data = None
    # if log_entry.data:  # ← This line causes the error
    #     try:
    #         parsed_data = json.loads(log_entry.data) if isinstance(log_entry.data, str) else log_entry.data
    #     except:
    #         parsed_data = str(log_entry.data)
    
    # Get user activity summary
    user_summary = UserActivityLog.objects.filter(user=log_entry.user).aggregate(
        total_actions=Count('id'),
        unique_models=Count('model_name', distinct=True),
        last_action=Max('timestamp')
    )
    
    # Get action type distribution for this user
    user_action_types = UserActivityLog.objects.filter(
        user=log_entry.user
    ...
    context = {
        ...
        # Remove parsed_data from context
        # 'parsed_data': parsed_data,  # ← Remove this line
        'user_summary': user_summary,
        'user_action_types': user_action_types,
        'action_type_display': dict(UserActivityLog.ACTION_TYPES),
    }
    
    return render(request, 'pos/admin/activity_log_detail.html', context)

@login_required
def check_phone_exists(request):
    """Check if a phone number already exists in the system"""
    phone = request.GET.get('phone', '').strip()
    model_type = request.GET.get('model_type', 'customer')
    ...
    if model_type == 'customer':
        ...
        if exclude_id and exclude_id != 'None' and exclude_id.isdigit():
            queryset = queryset.exclude(id=int(exclude_id))
        exists = queryset.exists()
        message = 'A customer with this phone number already exists.' if exists else ''
    elif model_type == 'supplier':
        queryset = Supplier.objects.filter(phone=phone)
        if exclude_id and exclude_id != 'None' and exclude_id.isdigit():
            queryset = queryset.exclude(id=int(exclude_id))
        exists = queryset.exists()
        message = 'A supplier with this phone number already exists.' if exists else ''
    else:
        return JsonResponse({
            'exists': False,
